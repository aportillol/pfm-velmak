...
def convert_markdown_to_html():
    ...
    output_file = "SECCION_1_RESUMEN_EJECUTIVO_PFM_VELMAK.html"
    ...
    <div class="container">
        <div class="no-print">
            <div class="header-info">
                <h3>📋 SECCIÓN 1: RESUMEN EJECUTIVO</h3>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Resumen Ejecutivo a HTML (para PDF)")
    print("=" * 60)
    
    success, html_file = convert_markdown_to_html()
