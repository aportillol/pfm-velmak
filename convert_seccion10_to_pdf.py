...
def convert_seccion10_to_html():
    # Configuración de rutas
    input_file = "SECCION_10_ANEXOS_PFM_VELMAK.md"
    output_file = "SECCION_10_ANEXOS_PFM_VELMAK.html"
...
<head>
    ...
    <title>SECCIÓN 10: ANEXOS - PFM VELMAK</title>
    <style>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Sección 10 Anexos a HTML (para PDF)")
    print("=" * 70)
    
    success, html_file = convert_seccion10_to_html()
