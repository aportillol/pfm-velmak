...
def convert_seccion2_to_html():
    # Configuración de rutas
    input_file = "SECCION_2_PLAN_JURIDICO_LEGAL_PFM_VELMAK.md"
    output_file = "SECCION_2_PLAN_JURIDICO_LEGAL_PFM_VELMAK.html"
...
<head>
    ...
    <title>SECCIÓN 2: PLAN JURÍDICO-LEGAL - PFM VELMAK</title>
    <style>
    ...
    <div class="container">
        <div class="no-print">
            <div class="header-info">
                <h3>⚖️ SECCIÓN 2: PLAN JURÍDICO-LEGAL</h3>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Sección 2 Jurídico-Legal a HTML (para PDF)")
    print("=" * 70)
    
    success, html_file = convert_seccion2_to_html()
