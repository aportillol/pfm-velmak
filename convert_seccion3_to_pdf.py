...
def convert_seccion3_to_html():
    # Configuración de rutas
    input_file = "SECCION_3_PLAN_ESTRATEGICO_PFM_VELMAK.md"
    output_file = "SECCION_3_PLAN_ESTRATEGICO_PFM_VELMAK.html"
...
<head>
    ...
    <title>SECCIÓN 3: PLAN ESTRATÉGICO - PFM VELMAK</title>
    <style>
    ...
    <div class="container">
        <div class="no-print">
            <div class="header-info">
                <h3>🎯 SECCIÓN 3: PLAN ESTRATÉGICO</h3>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Sección 3 Plan Estratégico a HTML (para PDF)")
    print("=" * 70)
    
    success, html_file = convert_seccion3_to_html()
