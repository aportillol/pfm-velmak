...
def convert_seccion6_to_html():
    # Configuración de rutas
    input_file = "SECCION_6_PLAN_RECURSOS_HUMANOS_PFM_VELMAK.md"
    output_file = "SECCION_6_PLAN_RECURSOS_HUMANOS_PFM_VELMAK.html"
...
<head>
    ...
    <title>SECCIÓN 6: PLAN DE RECURSOS HUMANOS - PFM VELMAK</title>
    <style>
    ...
    <div class="container">
        <div class="no-print">
            <div class="header-info">
                <h3>👥 SECCIÓN 6: PLAN DE RECURSOS HUMANOS</h3>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Sección 6 Recursos Humanos a HTML (para PDF)")
    print("=" * 75)
    
    success, html_file = convert_seccion6_to_html()
