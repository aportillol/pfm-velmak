...
def convert_seccion8_to_html():
    # Configuración de rutas
    input_file = "SECCION_8_PLAN_CONTINGENCIAS_PFM_VELMAK.md"
    output_file = "SECCION_8_PLAN_CONTINGENCIAS_PFM_VELMAK.html"
...
<head>
    ...
    <title>SECCIÓN 8: PLAN DE CONTINGENCIAS - PFM VELMAK</title>
    <style>
    ...
    <div class="container">
        <div class="no-print">
            <div class="header-info">
                <h3>🛡️ SECCIÓN 8: PLAN DE CONTINGENCIAS</h3>
...
if __name__ == "__main__":
    print("🚀 Iniciando conversión de Sección 8 Plan de Contingencias a HTML (para PDF)")
    print("=" * 75)
    
    success, html_file = convert_seccion8_to_html()
