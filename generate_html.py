...
def generate_html():
    """Genera HTML a partir del Markdown del Capítulo 1"""
    
    # Archivos
    md_file = 'CAPITULO_1_INTRODUCCION_COMPLETO.md'
    html_file = 'CAPITULO_1_INTRODUCCION_COMPLETO.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 1: Introducción - PFM VELMAK</title>
    {css_styles}
</head>
<body>
{html_content}
