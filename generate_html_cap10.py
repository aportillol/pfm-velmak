...
def generate_html_cap10():
    """Genera HTML a partir del Markdown del Capítulo 10"""
    
    # Archivos
    md_file = 'CAPITULO_10_PRIVACIDAD_ETICA.md'
    html_file = 'CAPITULO_10_PRIVACIDAD_ETICA.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 10: Gestión de la Privacidad y Ética del Dato</title>
    {css_styles}
</head>
<body>
{html_content}
