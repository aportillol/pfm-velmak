...
def generate_html_cap11():
    """Genera HTML a partir del Markdown del Capítulo 11"""
    
    # Archivos
    md_file = 'CAPITULO_11_MEDICION_CONTROL.md'
    html_file = 'CAPITULO_11_MEDICION_CONTROL.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 11: Medición y Control del Modelo de Datos Mejorado</title>
    {css_styles}
</head>
<body>
{html_content}
