...
def generate_html_cap12():
    """Genera HTML a partir del Markdown del Capítulo 12"""
    
    # Archivos
    md_file = 'CAPITULO_12_CRONOGRAMA_METRICAS.md'
    html_file = 'CAPITULO_12_CRONOGRAMA_METRICAS.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 12: Cronograma y Métricas de Éxito</title>
    {css_styles}
</head>
<body>
{html_content}
