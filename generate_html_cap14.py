...
def generate_html_cap14():
    """Genera HTML a partir del Markdown del Capítulo 14"""
    
    # Archivos
    md_file = 'CAPITULO_14_RIESGOS_CONTINGENCIAS.md'
    html_file = 'CAPITULO_14_RIESGOS_CONTINGENCIAS.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 14: Riesgos y Contingencias</title>
    {css_styles}
</head>
<body>
{html_content}
