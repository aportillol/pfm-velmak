...
def generate_html_cap15():
    """Genera HTML a partir del Markdown del Capítulo 15"""
    
    # Archivos
    md_file = 'CAPITULO_15_CONCLUSIONES_RECOMENDACIONES.md'
    html_file = 'CAPITULO_15_CONCLUSIONES_RECOMENDACIONES.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 15: Conclusiones y Recomendaciones</title>
    {css_styles}
</head>
<body>
{html_content}
