...
def generate_html_cap16():
    """Genera HTML a partir del Markdown del Capítulo 16"""
    
    # Archivos
    md_file = 'CAPITULO_16_BIBLIOGRAFIA_REFERENCIAS.md'
    html_file = 'CAPITULO_16_BIBLIOGRAFIA_REFERENCIAS.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 16: Bibliografía y Referencias</title>
    {css_styles}
</head>
<body>
{html_content}
