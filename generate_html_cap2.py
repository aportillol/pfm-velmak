...
def generate_html_cap2():
    """Genera HTML a partir del Markdown del Capítulo 2"""
    
    # Archivos
    md_file = 'CAPITULO_2_ANALISIS_EMPRESA.md'
    html_file = 'CAPITULO_2_ANALISIS_EMPRESA.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 2: Análisis de la Empresa y su Modelo de Datos Actual - PFM VELMAK</title>
    {css_styles}
</head>
<body>
{html_content}
