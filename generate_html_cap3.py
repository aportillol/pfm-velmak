...
def generate_html_cap3():
    """Genera HTML a partir del Markdown del Capítulo 3"""
    
    # Archivos
    md_file = 'CAPITULO_3_MODELO_NEGOCIO.md'
    html_file = 'CAPITULO_3_MODELO_NEGOCIO.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 3: Modelo de Negocio para PFM VELMAK en el Sector Financiero</title>
    {css_styles}
</head>
<body>
{html_content}
