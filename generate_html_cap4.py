...
def generate_html_cap4():
    """Genera HTML a partir del Markdown del Capítulo 4"""
    
    # Archivos
    md_file = 'CAPITULO_4_ANALISIS_MERCADO.md'
    html_file = 'CAPITULO_4_ANALISIS_MERCADO.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 4: Análisis del Mercado y Competidores</title>
    {css_styles}
</head>
<body>
{html_content}
