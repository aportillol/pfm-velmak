...
def generate_html_cap5():
    """Genera HTML a partir del Markdown del Capítulo 5"""
    
    # Archivos
    md_file = 'CAPITULO_5_RECOLECCION_DATOS.md'
    html_file = 'CAPITULO_5_RECOLECCION_DATOS.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 5: Recolección de Datos</title>
    {css_styles}
</head>
<body>
{html_content}
