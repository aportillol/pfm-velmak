...
def generate_html_cap6():
    """Genera HTML a partir del Markdown del Capítulo 6"""
    
    # Archivos
    md_file = 'CAPITULO_6_MEJORAS_MODELO.md'
    html_file = 'CAPITULO_6_MEJORAS_MODELO.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 6: Mejoras en el Modelo de Datos</title>
    {css_styles}
</head>
<body>
{html_content}
