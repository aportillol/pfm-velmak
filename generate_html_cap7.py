...
def generate_html_cap7():
    """Genera HTML a partir del Markdown del Capítulo 7"""
    
    # Archivos
    md_file = 'CAPITULO_7_MONETIZACION.md'
    html_file = 'CAPITULO_7_MONETIZACION.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 7: Modelo de Monetización</title>
    {css_styles}
</head>
<body>
{html_content}
