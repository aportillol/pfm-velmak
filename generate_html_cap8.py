...
def generate_html_cap8():
    """Genera HTML a partir del Markdown del Capítulo 8"""
    
    # Archivos
    md_file = 'CAPITULO_8_EQUIPO_RECURSOS.md'
    html_file = 'CAPITULO_8_EQUIPO_RECURSOS.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 8: Equipo y Recursos</title>
    {css_styles}
</head>
<body>
{html_content}
