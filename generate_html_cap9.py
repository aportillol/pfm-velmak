...
def generate_html_cap9():
    """Genera HTML a partir del Markdown del Capítulo 9"""
    
    # Archivos
    md_file = 'CAPITULO_9_EVALUACION_EFECTIVIDAD.md'
    html_file = 'CAPITULO_9_EVALUACION_EFECTIVIDAD.html'
...
<head>
    <meta charset='UTF-8'>
    <title>Capítulo 9: Evaluación de la Efectividad de las Mejoras</title>
    {css_styles}
</head>
<body>
{html_content}
